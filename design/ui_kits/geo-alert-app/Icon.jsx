// Icon.jsx — Lucide-style inline SVGs as a single dispatcher.
// Stroke-based, currentColor, 1.5–2px stroke, 24px default.
const ICONS = {
...
function Icon({ name, size = 24, fill = 'none', stroke = 'currentColor', sw = 2, ...rest }) {
  return (
